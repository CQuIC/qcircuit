...
& \ctrl{1} & \qw & \push{{}={}} & & \ctrl{1} & \targ & \ctrl{1} & \targ & \qw & \qw\\
...
\noindent in the preamble of your document.  \verb=qcircuit.sty= loads the \verb=xy= package and implements a set of circuit commands.  If need be, you can obtain the necessary packages at \href{http://www.ctan.org/}{http://www.ctan.org/}.
...
You can also use qcircuit with plain \TeX.  There you simply do
{\small \begin{verbatim}\input qcircuit.sty\end{verbatim}}\noindent
To select the package options you have to use a special command for option selection
{\small \begin{verbatim}\Qcircuitoption{options}\end{verbatim}}\noindent
where \verb=options= is a comma separated list of options.
