...
the skill to render arbitrary QCDs in a matter of minutes.  qcircuit is available for free\footnote{The qcircuit package is distributed under the GNU public license.} at \href{http://info.phys.unm.edu/Qcircuit/}{http://info.phys.unm.edu/Qcircuit/}.
\end{abstract}
...
As mentioned above, qcircuit comes with predefined commands for some commonly used functions. We have chosen to use the ensuremath command, meaning you do not need to put dollar signs around the calls to these commands.

We demonstrate the functions below:\\
A ket \ket{\frac{A}{B}}\\
A bra \bra{\frac{A}{B}}\\
An inner product \ip{\frac{A}{B}}{\frac{C}{D}}\\
An outer product \op{\frac{A}{B}}{\frac{C}{D}}\\
A matrix element \melem{j}{\frac{\rho}{\sigma}}{k}\\
An expectation value \expval{\frac{\Omega}{\gamma}}
